...
from csbgnpy.af.io_utils import *
...
def make_dot_layout(net, prog = "dot", ranksep = 1.2, nodesep = 0.8, xoffset = 10, yoffset = 10):
    ...
    scaling = 1 / 72
    layout = {}
    G = pg.AGraph(nodesep = nodesep, ranksep = ranksep)
    dids = {}
    i = 0
    for act in net.activities:
        dids[act] = i
